      ...
      <header className="relative z-10 h-16 border-b border-border flex items-center justify-between px-6 glass shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 glass rounded-lg p-1 border border-border">
            <button className="p-1.5 text-muted-foreground hover:text-foreground rounded hover:bg-foreground/5">
      ...
      <div className="relative flex-1 bg-background overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <svg
              ...
              style={{ filter: "drop-shadow(0 0 8px oklch(0.65 0.25 320 / 0.5))" }}
            >
              {/* Lines */}
              <motion.path
                d="M 400 100 L 400 220"
                stroke="currentColor"
                strokeWidth="2"
                strokeDasharray="4 4"
        ...
        <div className="absolute bottom-6 left-6 glass p-4 rounded-2xl border border-border w-64 shadow-2xl">
          ...
          <p className="text-xs text-muted-foreground mb-4">
            Core module handling user sessions, OAuth, and JWT lifecycle.
          </p>
          <div className="space-y-2 text-xs">
            <div className="flex justify-between">
              <span className="text-muted-foreground">Dependencies</span> <span>4 Modules</span>
            </div>
            <div className="flex justify-between">
  ...
  return (
    <div className="absolute group" style={{ left: x, top: y, transform: "translate(-50%, -50%)" }}>
      ...
      >
        ...
        {/* Glow behind node */}
        {active && (
          <div className="absolute inset-0 rounded-full bg-fuchsia-400 animate-ping opacity-20" />
        )}
      </div>
