    ...
    <main className="h-screen bg-background text-foreground flex overflow-hidden">
      ...
      <aside className="relative z-10 w-64 border-r border-border flex flex-col p-4 glass shrink-0">
        <Link
          to="/workspace/$repoId"
          params={{ repoId }}
          className="text-muted-foreground hover:text-foreground transition mb-8 flex items-center gap-2 text-sm font-medium"
        >
          <ArrowRight className="size-4 rotate-180" /> Back to Workspace
        </Link>

        <h2 className="text-xs uppercase tracking-widest text-muted-foreground px-2 mb-3">
          Generated Docs
        </h2>
      ...
      <div className="relative z-10 flex-1 overflow-y-auto flex flex-col">
        ...
        <div className="p-8 md:p-12 max-w-4xl mx-auto w-full">
          <div className="prose prose-invert prose-p:text-muted-foreground prose-headings:font-display prose-headings:font-normal max-w-none">
            ...
            <p className="text-lg">
              A modern, high-performance e-commerce architecture built with React, Node.js, and
              PostgreSQL. This documentation is automatically maintained and updated by CodePilot AI
            ...
            <div className="p-6 rounded-3xl glass border border-border not-prose mb-8">
              <div className="flex items-center gap-8 justify-center opacity-80">
                <div className="text-center">
                  <Database className="size-8 mx-auto mb-2 text-fuchsia-400" />{" "}
                  <span className="text-sm">PostgreSQL</span>
                </div>
                <div className="h-px w-16 bg-border" />
                <div className="text-center">
                  <Globe className="size-8 mx-auto mb-2 text-cyan-400" />{" "}
                  <span className="text-sm">Express API</span>
                </div>
                <div className="h-px w-16 bg-border" />
                <div className="text-center">
                  <LayoutGrid className="size-8 mx-auto mb-2 text-emerald-400" />{" "}
            ...
            <ul>
              <li>
                <strong>Authentication:</strong> JWT-based auth with refresh token rotation (see{" "}
              ...
              <li>
                <strong>Payments:</strong> Stripe webhooks handled securely with pessimistic
                locking.
              </li>
              <li>
                <strong>Inventory:</strong> Real-time inventory deduction during checkout.
              </li>
            </ul>
