              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-border">
                  <ActivityRow
                    ...
                    action="Generated test suite"
                    ws="ecommerce-v2"
                    time="2m ago"
                  />
                  <ActivityRow
                    user="mark.s@company.com"
                    action="Connected repo"
                    ws="payment-gateway"
                    time="15m ago"
                  />
                  <ActivityRow
...
function StatCard({ icon: Icon, label, value, color }: any) {
  return (
    <div
      ...
      style={{ borderLeftColor: `var(--color-${color.split("-")[1]}-400)` }}
    >
  ...
  return (
    <tr className="hover:bg-foreground/5 transition">
      ...
      <td className="px-6 py-4">
        <span className="bg-foreground/10 px-2 py-1 rounded text-xs">{ws}</span>
      </td>
