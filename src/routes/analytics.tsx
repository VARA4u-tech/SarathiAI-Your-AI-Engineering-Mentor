      ...
      <div className="relative z-10 flex-1 overflow-y-auto p-6 md:p-10">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <StatCard icon={Activity} label="Total AI Operations" value="12,482" trend="+14%" color="text-fuchsia-400" />
            <StatCard icon={Clock} label="Hours Saved" value="342h" trend="+22%" color="text-emerald-400" />
            <StatCard icon={TrendingUp} label="Code Generated" value="84K lines" trend="+8%" color="text-cyan-400" />
            ...
            <div className="md:col-span-2 glass rounded-3xl p-6 border border-border h-[400px] flex flex-col">
              ...
              <div className="flex-1 flex items-end gap-2 px-4">
                {[40, 60, 45, 80, 55, 90, 75, 100, 85, 110, 95, 120].map((h, i) => (
                  <div key={i} className="flex-1 bg-gradient-to-t from-fuchsia-400/50 to-cyan-400/50 rounded-t-sm" style={{ height: `${(h/120)*100}%` }} />
                ))}
              </div>
