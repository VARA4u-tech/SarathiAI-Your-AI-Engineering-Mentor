      ...
      <div className="relative mx-auto w-[min(96%,1200px)] text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-left">
          {benefitsList.map((b, i) => (
            ...
            >
              <div className="absolute top-0 right-8 bg-gradient-to-b from-foreground/10 to-transparent w-16 h-32 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity" />
