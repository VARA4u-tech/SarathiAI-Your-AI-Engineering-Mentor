        ...
        <div className="lg:w-[45%] flex flex-col items-start lg:sticky lg:top-32 h-fit">
          ...
          >
            ...
            <p className="text-white/40 leading-relaxed mb-10 max-w-md">
              I build scalable, AI-powered applications that solve real engineering problems.
              Sarathi.ai is my flagship hackathon project, demonstrating full-stack architecture,
              seamless LLM integration, and modern frontend design.
            </p>
            ...
            <div className="group relative p-8 rounded-3xl bg-gradient-to-b from-white/5 to-transparent border border-white/10 hover:border-white/20 transition-colors overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <a
                    href="https://github.com/VARA4u-tech/codepilot-ai"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <p className="text-white/50 leading-relaxed mb-6">
                  An AI Engineering Operating System. Built during a competitive hackathon to
                  showcase how agentic AI can automate repository understanding, code planning, and
                ...
                <div className="flex flex-wrap gap-2">
                  {["React", "TypeScript", "TanStack", "Tailwind", "Python", "LLMs"].map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 rounded-full bg-white/5 text-xs text-white/70 border border-white/10"
                    >
                      {tech}
                    </span>
                  ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/40">
                    Python, FastAPI, Node.js, Postgres, Docker.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/40">
                    OpenAI, LLM, RAG Pipelines, Agentic Frameworks.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/40">
                    Data Structures, Algorithms, Architecture Design, OS Concepts.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative pl-6 border-l border-white/10 pb-8">
              ...
              <p className="text-white/50 text-sm">
                Focusing on advanced computing, software engineering methodologies, and artificial
                intelligence.
              </p>
            </div>
          </motion.section>
