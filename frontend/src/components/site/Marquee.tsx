  ...
  return (
    <section className="relative py-24 overflow-hidden flex flex-col items-center bg-transparent z-10">
      <div className="mb-12 flex flex-col items-center gap-4">
        <p className="uppercase tracking-[0.3em] text-xs font-semibold text-muted-foreground/60">
          ...
          <div className="flex shrink-0 items-center">
            {items.map((n, i) => (
              <div key={`a-${i}`} className="flex items-center px-8 md:px-12">
                ...
                <span className="ml-16 md:ml-24 text-fuchsia-500 text-3xl md:text-4xl drop-shadow-[0_0_15px_rgba(217,70,239,0.5)]">
                  ✦
                </span>
              </div>
            ))}
