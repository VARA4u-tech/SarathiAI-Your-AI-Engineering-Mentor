          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 py-10 lg:py-16 flex-grow">
            <div className="md:col-span-4 flex flex-col gap-6">
              ...
              <div className="flex items-center gap-3 mt-4">
                ...
                <a href="https://github.com/VARA4u-tech" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-white hover:text-black hover:border-white transition-all hover:scale-110">
            ...
            <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
              <div className="flex flex-col gap-4">
                ...
                {[
                  ...
                  <Link key={item.name} to={item.to} className="group flex items-center text-white/50 hover:text-white transition-colors w-fit">
