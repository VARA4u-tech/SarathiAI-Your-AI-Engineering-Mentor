  ...
  return (
    ...
    >
      <div className="relative md:fixed bottom-0 w-full h-auto md:h-[700px] lg:h-[800px] bg-[#050505] text-white flex flex-col justify-between overflow-hidden">
        ...
        {isMobile ? (
          <div className="relative z-10 flex flex-col h-full justify-between pt-16 md:pt-32 pb-20 md:pb-8 px-6 md:px-16 max-w-[1600px] mx-auto w-full">
            {/* Top Section: Giant CTA */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-12 border-b border-white/10 pb-10 lg:pb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 py-8 lg:py-16 flex-grow">
              <div className="md:col-span-4 flex flex-col gap-6">
                ...
                <p className="text-white/40 max-w-xs leading-relaxed text-sm lg:text-base">
                  The ultimate AI Engineering OS. Transform how your team builds, scales, and
                  maintains software.
                </p>
                ...
                <div className="flex items-center gap-3 mt-4">
                  ...
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-white hover:text-black hover:border-white transition-all hover:scale-110"
                  >
              ...
              <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-y-10 gap-x-4 md:gap-8">
                <div className="flex flex-col gap-4">
                  <h4 className="text-white font-semibold mb-2 uppercase tracking-widest text-xs">
                    Product
                  </h4>
                  {[
                    ...
                    <Link
                      key={item.name}
                      to={item.to}
                      className="group flex items-center text-white/50 hover:text-white transition-colors w-fit"
                    >
            ...
            {/* Bottom Footer Info */}
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-xs lg:text-sm text-white/30 pt-6 border-t border-white/5">
              ...
              <div className="flex flex-1 justify-center md:justify-end gap-6">
          ...
          <motion.div
            style={{ y, opacity }}
            className="relative z-10 flex flex-col h-full justify-between pt-16 md:pt-32 pb-20 md:pb-8 px-6 md:px-16 max-w-[1600px] mx-auto w-full"
          >
            {/* Top Section: Giant CTA */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-12 border-b border-white/10 pb-10 lg:pb-16">
              <div className="flex flex-col gap-6 max-w-3xl">
        ...
        <div className="absolute bottom-[-10px] md:bottom-[-5%] left-0 w-full flex justify-center pointer-events-none select-none overflow-hidden opacity-[0.06] md:opacity-[0.07] z-0">
          <h1 className="text-[23vw] md:text-[27vw] font-display font-bold leading-none tracking-tighter text-white whitespace-nowrap">
            SARATHI
          </h1>
        </div>
      </div>
